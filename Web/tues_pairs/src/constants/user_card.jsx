    ...
    return(
        <Card bg="dark" style={{ width: '20.6rem' , borderColor: color}} className="profile-card">
            ...
            <Card.Body className="profile-body">
                ...
                {!thisUser.isTeacher &&<Card.Subtitle className="description" data-testid="student">His idea</Card.Subtitle>}
                {thisUser.isTeacher &&<Card.Subtitle className="description" data-testid="student">Interested in</Card.Subtitle>}
